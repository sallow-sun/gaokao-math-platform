...
public class ProblemController {
  ...
  public PageResponse<ProblemListVO> problems(
      ...
      @RequestParam(required = false, name = "learned") List<String> learned,
      @RequestParam(required = false, name = "chapter") List<String> chapters,
  ...
  public ProblemCatalogVO catalogs() {
    return problemService.catalog();
  }

  @GetMapping("/problem-stats")
  public ProblemCollectionStatsVO stats() {
    return problemService.collectionStats();
  }
}
