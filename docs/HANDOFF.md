...
- 已部署功能提交：`8a8dbca4daa5e34967a4177deb589e7b4e7cfbc0`。后续交接文档提交不改变部署产物。
- 网站：https://mathverse.com.cn 。入口：管理后台 → 题目管理 → **原卷整理**。
- 前端版本：`/var/www/mathsea-releases/editorial-20260915T011338Z`。
- 本次备份：`/srv/mathsea/backups/editorial-20260915T011338Z`。
