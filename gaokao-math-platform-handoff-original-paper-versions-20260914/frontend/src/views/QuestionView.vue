...
import { clearAssistantContext, setAssistantContext } from '../features/ai-assistant/assistantContext.js'
import '../assets/styles/question.css'

const AI_CONTEXT_OWNER = 'question-view'
...
watch(
  ...
  (item) => {
    if (!item) {
      clearAssistantContext(AI_CONTEXT_OWNER)
      return
    }
    setAssistantContext(AI_CONTEXT_OWNER, {
      type: 'problem',
      id: item.id,
      title: item.title,
      text: item.content,
