...
const displayedAvatarUrl = computed(() =>
  props.editable ? avatarUrl.value || props.profile.avatarUrl : props.profile.avatarUrl,
)
const displayedName = computed(() =>
  props.editable ? profileName.value || props.profile.username : props.profile.username,
)
